...
Several examples are provided in the [`e2e-fixtures` folder](https://github.com/Abdiramen/kubernetes-operator-rename/tree/main/e2e-fixtures). To use an example, make a copy of the included `EXAMPLE*config.yaml` in the same directory, like this:
