...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination dialer.go github.com/Abdiramen/kubernetes-operator-rename/pkg/tunneldriver Dialer
